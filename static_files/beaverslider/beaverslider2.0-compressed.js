...
,{
id:37,group:"slideOver",name:"slideOverLeft",duration:1000,size:null,steps:null,run:this.slideOverLeft}
,{
id:38,group:"slideOver",name:"slideOverRight",duration:1000,size:null,steps:null,run:this.slideOverRight}
,{
id:39,group:"slideOver",name:"slideOverUp",duration:1000,size:null,steps:null,run:this.slideOverUp}
,{
id:40,group:"slideOver",name:"slideOverDown",duration:1000,size:null,steps:null,run:this.slideOverDown}
];
...
for(j=0;
j<this.effects.length;
j++){
if(this.effects[j].group.toLowerCase()==f.toLowerCase()||this.effects[j].name.toLowerCase()==f.toLowerCase()){
this.userEffects.push({
id:this.effects[j].id,group:this.effects[j].group,name:this.effects[j].name,duration:(h)?h:this.effects[j].duration,size:(g)?g:this.effects[j].size,steps:(e)?e:this.effects[j].steps,run:this.effects[j].run}
)}
}
}
}
...
overflow:"hidden",width:this.settings.structure.container.width,height:this.settings.structure.container.height}
).append(jQuery("<img>").attr("src",this.settings.content.images[this.currentImage]).css({
width:this.settings.structure.container.width,height:this.settings.structure.container.height,display:"block",margin:0}
))}
else{
this.areaMain=jQuery("<div>").css({
overflow:"hidden",width:this.settings.structure.container.width,height:this.settings.structure.container.height,background:"url("+this.settings.content.images[this.currentImage]+")  no-repeat" ,"background-size":this.settings.structure.container.width+"px "+this.settings.structure.container.height+"px"}
)}
this.areaEffects=jQuery("<div>").css({
width:this.settings.structure.container.width,height:this.settings.structure.container.height,position:"absolute",left:0,top:0,overflow:"hidden","z-index":(this.settings.structure.container.zIndexScreen)?this.settings.structure.container.zIndexScreen:90}
);
this.areaEffectsTemplate=this.areaEffects.clone();
this.areaWidgets=jQuery("<div>").css({
width:this.settings.structure.container.width,height:this.settings.structure.container.height,position:"absolute",left:0,top:0,"z-index":(this.settings.structure.container.zIndexWidgets)?this.settings.structure.container.zIndexWidgets:100,background:"url(about:blank)"}
).hover(function(){
if(b.playerFadeNow){
return}
...
this.container.attr({
engine:"BeaverSlider",reference:"http://beaverslider.com"}
).css({
position:"relative"}
...
for(i=0;
i<this.settings.content.images.length;
i++){
...
b.stopSliding(parseInt(jQuery(this).attr("inarray")))}
).append(e))}
...
width:this.settings.structure.container.width,height:this.settings.structure.container.height,overflow:"hidden",position:"relative"}
).append(jQuery("<div>").css({
position:"absolute",left:this.settings.structure.messages.left?this.settings.structure.messages.left:"auto",top:this.settings.structure.messages.top?this.settings.structure.messages.top:"auto",bottom:this.settings.structure.messages.bottom?this.settings.structure.messages.bottom:"auto",right:this.settings.structure.messages.right?this.settings.structure.messages.right:"auto"}
...
position:"absolute",left:this.settings.structure.player.left?this.settings.structure.player.left:"auto",right:(this.settings.structure.player.right)?this.settings.structure.player.right:"auto",top:this.settings.structure.player.top?this.settings.structure.player.top:"auto",bottom:this.settings.structure.player.bottom?this.settings.structure.player.bottom:"auto"}
...
width:e+"px",height:f+"px","float":"left",margin:0,overflow:"hidden",visibility:"hidden",position:"relative"}
).attr({
chessboardx:j,chessboardy:i}
).append(jQuery("<div>").css({
width:e+"px",height:f+"px",overflow:"hidden",visibility:"hidden",position:"absolute",background:"url("+this.settings.content.images[this.currentImage]+") "+l+" no-repeat","background-size":this.settings.structure.container.width+"px "+this.settings.structure.container.height+"px"}
)));
h=(j==n-1)?0:(h-e)}
r-=f}
}
...
var f=g?g:0,e=this.currentEffect.steps*1;
setTimeout(function(){
if(f>=b.cells.length){
...
var g=l?l:0,f=this.currentEffect.steps*1;
setTimeout(function(){
if(g>=b.cells.length){
...
var q=jQuery(this).innerHeight(),p=jQuery(this).innerWidth();
if(e){
...
width:b.settings.structure.container.width+"px",height:b.settings.structure.container.height+"px",margin:0}
).animate({
width:Math.round((1+this.currentEffect.size/100)*this.settings.structure.container.width)+"px",height:Math.round((1+this.currentEffect.size/100)*this.settings.structure.container.height)+"px",marginLeft:Math.round(-1*f*this.settings.structure.container.width)+"px",marginTop:Math.round(-1*e*this.settings.structure.container.height)+"px"}
...
var e=this.areaEffects.children().css("width",this.settings.structure.container.width*2+"px"),f=e.children().css("left",this.settings.structure.container.width+"px");
jQuery("<div>").css({
background:this.areaMain.css("background"),position:"absolute",width:this.settings.structure.container.width+"px",height:this.settings.structure.container.height+"px"}
).appendTo(e);
e.animate({
...
width:this.settings.structure.container.width*2+"px","margin-left":"-"+this.settings.structure.container.width+"px"}
);
jQuery("<div>").css({
background:this.areaMain.css("background"),position:"absolute",width:this.settings.structure.container.width+"px",height:this.settings.structure.container.height+"px",left:this.settings.structure.container.width+"px"}
).appendTo(e);
e.animate({
marginLeft:0}
,parseInt(this.currentEffect.duration),function(){
...
this.drawCells(1,1);
this.areaEffects.find("div").css("visibility","visible");
var e=this.areaEffects.children().css("height",this.settings.structure.container.height*2+"px"),f=e.children().css("top",this.settings.structure.container.height+"px");
jQuery("<div>").css({
background:this.areaMain.css("background"),position:"absolute",width:this.settings.structure.container.width+"px",height:this.settings.structure.container.height+"px"}
).appendTo(e);
e.animate({
...
this.areaEffects.find("div").css("visibility","visible");
var e=this.areaEffects.children().css({
height:this.settings.structure.container.height*2+"px","margin-top":"-"+this.settings.structure.container.height+"px"}
);
jQuery("<div>").css({
background:this.areaMain.css("background"),position:"absolute",width:this.settings.structure.container.width+"px",height:this.settings.structure.container.height+"px",top:this.settings.structure.container.height+"px"}
).appendTo(e);
e.animate({
marginTop:0}
,parseInt(this.currentEffect.duration),function(){
...
left:this.settings.structure.container.width+"px",opacity:0}
);
f.animate({
left:0,opacity:1}
,parseInt(this.currentEffect.duration),function(){
...
this.areaEffects.find("div").css("visibility","visible");
var e=this.areaEffects.children(),f=e.children().css({
top:this.settings.structure.container.width+"px",opacity:0}
);
f.animate({
top:0,opacity:1}
,parseInt(this.currentEffect.duration),function(){
...
for(i=0;
i<this.currentEffect.size*2-1;
i++){
for(j=0;
j<this.currentEffect.size;
j++){
for(k=0;
k<this.currentEffect.size;
k++){
if(j+k==i){
...
this.drawCells(this.currentEffect.size,this.currentEffect.size);
var l=this.areaEffects.children(),n=new Array(),g=this.currentEffect.size*this.currentEffect.size;
for(i=0;
i<this.currentEffect.size;
i++){
for(j=0;
j<this.currentEffect.size;
j++){
...
j<this.currentEffect.size;
j++){
var m=Math.floor(Math.random()*g)%n.length,f=0,h;
while(m!=-1){
if(n[f]){
m--;
h=f}
...
this.drawCells(this.currentEffect.size,1);
var g=this.areaEffects.children(),l=new Array();
for(i=0;
i<this.currentEffect.size;
i++){
l[i]=i+",1"}
...
i<this.currentEffect.size;
i++){
var h=Math.floor(Math.random()*this.currentEffect.size)%l.length,e=0,f;
while(h!=-1){
if(l[e]){
h--;
f=e}
...
for(border=0;
border<Math.ceil(this.currentEffect.size/2);
border++){
...
for(border=Math.ceil(this.currentEffect.size/2)-1;
border>=0;
border--){
var f=Math.ceil(this.currentEffect.size/2)-1-border,e=this.currentEffect.size-1-f;
for(i=0;
i<this.currentEffect.size;
i++){
for(j=0;
...
this.drawCells(this.currentEffect.size,this.currentEffect.size);
var l=this.areaEffects.children(),n=new Array();
for(i=0;
i<Math.ceil(this.currentEffect.size/2);
i++){
n[i]=i+",1"}
for(border=Math.ceil(this.currentEffect.size/2)-1;
border>=0;
border--){
var m=Math.floor(Math.random()*Math.ceil(this.currentEffect.size/2))%n.length,g=0,h;
while(m!=-1){
if(n[g]){
m--;
h=g}
g=(g==n.length-1)?0:(g+1)}
var f=n[h].split(",")[0],e=this.currentEffect.size-1-f;
for(i=0;
i<this.currentEffect.size;
i++){
for(j=0;
...
i<this.currentEffect.size;
i++){
var e=h.filter("div[chessboardx='"+i+"']"),g,f=true;
e.css({
overflow:"hidden",visibility:"visible",opacity:1}
).children().css({
top:((i%2==0)?"-":"")+this.settings.structure.container.width+"px",visibility:"visible",opacity:1}
).animate({
top:0}
,parseInt(this.currentEffect.duration),function(){
if(f){
...
i<this.currentEffect.size;
i++){
var e=h.filter("div[chessboardy='"+i+"']"),g,f=true;
e.css({
overflow:"hidden",visibility:"visible",opacity:1}
).children().css({
left:((i%2==0)?"-":"")+this.settings.structure.container.width+"px",visibility:"visible",opacity:1}
).animate({
left:0}
,parseInt(this.currentEffect.duration),function(){
if(f){
...
overflow:"hidden",visibility:"visible",opacity:0,top:-b.settings.structure.container.height+"px"}
).animate({
top:0,opacity:1}
...
f.css({
left:"-999999999999999px",right:"auto",opacity:0}
);
if(!v){
return}
var g=f.outerWidth(),w=f.outerHeight();
f.css({
left:"auto",right:"auto",opacity:0}
);
var t=this.settings.structure.messages.right||0,h=this.settings.structure.messages.left||0,q=this.settings.structure.messages.top||0,e=this.settings.structure.messages.bottom||0,l,o,m,p=this.settings.animation.messageAnimationDirection.split(","),r=p[Math.floor(Math.random()*p.length)],n=function(y,z,A){
if(y<z){
if(z-y>A){
return z-A}
else{
...
,u=this.settings.animation.messageAnimationMaxHorLength||this.settings.structure.container.width/3,x=this.settings.animation.messageAnimationMaxVerLength||this.settings.structure.container.height/3;
switch(r){
case"right":o=h?h:(this.settings.structure.container.width-t-g);
m=-g;
l={
left:o,opacity:1}
;
f.css({
left:n(m,o,x),right:"auto",opacity:0}
);
break;
case"left":o=h?h:(this.settings.structure.container.width-t-g);
...
break;
case"down":o=q?q:(this.settings.structure.container.height-e-w);
m=-w;
l={
top:o,opacity:1}
;
f.css({
top:n(m,o,x),bottom:"auto",left:(h?h:"auto"),right:(t?t:"auto"),opacity:0}
);
break;
case"up":o=q?q:(this.settings.structure.container.height-e-w);
...
this.currentEffect={
id:this.effects[i].id,group:this.effects[i].group,name:this.effects[i].name,duration:(this.nextEffect.duration)?this.nextEffect.duration:this.effects[i].duration,size:(this.nextEffect.size)?this.nextEffect.size:this.effects[i].size,steps:(this.nextEffect.steps)?this.nextEffect.steps:this.effects[i].steps,run:this.effects[i].run}
;
break}
}
this.nextEffect=null}
