tinyMCE.init({
	...
	theme_advanced_buttons1 : "formatselect,fontsizeselect,|,fontselect,fontsizeselect,|,undo,redo,|,cut,copy,paste,pastetext,pasteword,|,search,replace,|,visualchars,visualaid,cleanup,code,preview,fullscreen",
